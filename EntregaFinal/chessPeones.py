...
def create_board(board):
    board[0][4] = Piece('b', 'k', 'b_king.png')

    board[7][4] =  Piece('w', 'k', 'w_king.png')
...
def chess(WIN, WIDTH):
    ...
    while True:
        ...
        pygame.draw.rect(WIN, (77, 0, 75), cuadroModo)
        pygame.draw.rect(WIN, (107, 1, 125), cuadroModo, 5)

        pygame.draw.rect(WIN, (0, 0, 0), bordeTablero, 10)

        draw_text1('V.S Jugador', font22, (200, 200, 200), WIN, 5, 570)
